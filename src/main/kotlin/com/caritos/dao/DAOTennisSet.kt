...
interface DAOTennisSet {
    ...
    suspend fun add(matchId: Int, setNumber: Int, teamAScore: Int, teamBScore: Int): TennisSet?
    suspend fun edit(id: Int, matchId: Int, setNumber: Int, teamAScore: Int, teamBScore: Int): Boolean
