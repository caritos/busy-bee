  ...
  <form action="/signup" method="post">
    <div class="flex justify-center items-center h-screen bg-indigo-600">
      <div class="w-96 p-6 shadow-lg bg-white rounded-md">
        ...
        <div class="mt-5">
          <button type="submit" value="Signup" class="border-2 border-indigo-700 bg-indigo-700 text-white py-1 w-full rounded-md hover:bg-transparent hover:text-indigo-700 font-semibold"><i class="fa-solid fa-right-to-bracket"></i>&nbsp;&nbsp;Signup</button>
        </div>
      </div>
    </div>
  </form>
