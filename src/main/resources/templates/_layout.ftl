<#macro header>
    ...
    <head>
        ...
        <script>
            ...
            posthog.init('phc_PnyF8gxY8USNB2avMyWkvxu2XnhISBXItYBm5dzNssf',{api_host:'https://us.i.posthog.com', person_profiles: 'identified_only' // or 'always' to create profiles for anonymous users as well
            })
        </script>
    </head>
